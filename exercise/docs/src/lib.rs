...
//! 
//! ![Pumpkin](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Pumpkin_Field.jpg/465px-Pumpkin_Field.jpg)

/// Big orange thing
/// # Recipes
/// Recipes will come soon
pub struct Pumpkin {
    /// Percent, valid values are between 0 and 1. 
    pub roundness: f32,
    /// Valid values are from 8 to 27
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// If you smash the pumpkin it will not be available for Pie 😭
    pub fn smash(self) {}
}
...
/// Default value for the `orangeness` field of the [Pumpkin] struct.
